...
## Key Findings (last updated 2026-04-03)
...
### Overrides (pnpm.overrides) - as of 2026-04-03
...
- `srvx`: Security fix (CVE <0.11.13), pinned to 0.11.14. Via @lenne.tech/nest-server>@tus/server. Note: @tus/server@2.3.0 still pins srvx to ~0.8.2 so override is needed.
...
- As of 2026-04-03, all 99 tests pass. No pre-existing failures.

### Deprecated Packages
- No deprecated packages found as of 2026-04-03.
